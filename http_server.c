...
void httpd_handler(struct evhttp_request *req, void *arg) {
    ...
    //cJSON *root = cJSON_CreateString(post_data);
...
void login_handler(struct evhttp_request *req, void *arg) 
{
	...
	cJSON *reqData = cJSON_Parse(request_data);
    /*
       具体的：可以根据GET/POST的参数执行相应操作，然后将结果输出
       ...
     */
	...
	printf("username = %s\n", cJSON_GetObjectItem(reqData, "username")->valuestring);
    printf("password = %s\n", cJSON_GetObjectItem(reqData, "password")->valuestring);
    printf("driver = %s\n", cJSON_GetObjectItem(reqData, "driver")->valuestring);
...
void reg_handler(struct evhttp_request *req, void *arg) 
{
    ...
    printf("password = %s\n", cJSON_GetObjectItem(reqData, "password")->valuestring);
    printf("driver = %s\n", cJSON_GetObjectItem(reqData, "driver")->valuestring);
	printf("email = %s\n", cJSON_GetObjectItem(reqData, "email")->valuestring);
    printf("phone = %s\n", cJSON_GetObjectItem(reqData, "tel")->valuestring);
    printf("id_card = %s\n", cJSON_GetObjectItem(reqData, "id_card")->valuestring);
	/**********************add 2017/9/16 17:00**********************************/
	cJSON *resRoot = cJSON_CreateObject();
	cJSON_AddStringToObject(resRoot, "result", "ok");
...
int main(int argc, char *argv[]) {
    ...
    evhttp_set_cb(httpd, "/reg", login_handler,NULL);
